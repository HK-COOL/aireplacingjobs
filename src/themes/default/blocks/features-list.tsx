  ...
  return (
    ...
    >
      <div className="container overflow-x-hidden">
        <div
          className={cn(
            'grid items-center gap-8 pb-12',
            hasImage ? 'lg:grid-cols-[minmax(0,500px)_1fr] lg:gap-20' : ''
          )}
        >
          {hasImage ? (
            <ScrollAnimation direction="left">
              <div className="mx-auto w-full max-w-[500px] md:mx-0">
                <LazyImage
                  ...
                  {section.buttons?.map((button, idx) => (
                    ...
                    >
                      <Link
                        ...
                        className={cn(
                          'focus-visible:ring-ring inline-flex max-w-full items-center justify-center gap-2 rounded-md text-sm font-medium transition-colors focus-visible:ring-1 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50',
                          'h-9 px-4 py-2',
