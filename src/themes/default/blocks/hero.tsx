...
export function Hero({
  ...
  return (
    <section
      id={section.id}
      className={cn(
        `overflow-x-hidden pt-24 pb-8 md:pt-36 md:pb-8`,
        section.className,
        className
      )}
    >
      ...
      <div className="relative mx-auto max-w-full px-4 text-center md:max-w-5xl">
        {texts && texts.length > 0 ? (
          <h1 className="text-foreground mx-auto max-w-[22rem] text-3xl leading-tight font-semibold break-words sm:mt-12 sm:max-w-5xl sm:text-5xl sm:text-balance md:text-6xl">
            {texts[0]}
        ...
        <p
          className="text-muted-foreground mx-auto mt-8 mb-8 max-w-[17rem] text-base leading-7 break-words sm:max-w-[36rem] sm:text-lg sm:text-balance"
